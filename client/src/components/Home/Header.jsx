  ...
  return (
       <section className='min-h-[500px] md:min-h-[750px] relative flex justify-center items-center overflow-hidden'> 
        ...
        <img 
          ...
          className={`${fadeInClass(loaded)} duration-500 absolute blur-[0px] scale-105 top-0 left-0 min-w-full max-w-full h-auto min-h-full max-h-full object-cover z-[-1] bg-secondary`}
        ...
        <div className='absolute top-[50%] md:top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] min-w-[350px] max-w-[500px]  mx-auto md:max-w-[900px] z-10 text-center pb-10'>
            <h1 className='text-primary text-3xl md:text-5xl font-bold mb-10 md:mb-10 z-[10] font-heading tracking-tight md:tracking-wider leading2'>
