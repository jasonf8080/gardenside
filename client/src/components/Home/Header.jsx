...
const Header = () => {
  ...
  return (
       <section className='min-h-[500px] md:min-h-[750px] relative flex justify-center items-center'> 
        ...
        <div className='absolute top-[50%] md:top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-w-[300px] mx-auto md:max-w-[900px] z-10 text-center pb-10'>
            <h1 className='text-primary text-2xl md:text-5xl font-bold mb-8 md:mb-4 z-[10] font-heading tracking-wider leading2'>
