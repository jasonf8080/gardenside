...
const Header = () => {
  ...
  return (
       <section className='relative z-[10] bg-secondary text-white mb-[150px]'> 
          {/* Content */}
          <div className="max-w-[90%] mx-auto flex flex-col justify-center items-center text-center translate-y-[40px]">
           ...
           <div className="flex items-center justify-center gap-4 text-[#838562]">
            <div className="w-12 h-px bg-[#838562]"></div>
            ...
            <h1 className='text-4xl md:text-6xl font-heading my-4'>GARDENSIDE KITCHEN & <br/> COFFEE BAR</h1>
             <p className='text-lg md:text-xl flex justify-center items-center text-[#838562] mb-6'>FRESH COFFEE • HANDCRAFTED PASTRIES • FOCCACIAS • LOCAL WINE • LATTES</p>
        ...
        <img 
          ...
          className={`${fadeInClass(loaded)} duration-500 blur-[0px] mx-auto w-[90%] h-[275px] md:m-[400px] translate-y-[100px] md:translate-y-[130px] relative z-[10] object-cover`}
