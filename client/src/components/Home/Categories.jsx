...
const Categories = () => {
    ...
    return (
        <section 
            ref={ref} 
            className='relative pt-[120px] md:pt-[150px]'
        >
                    ...
                    return (
                        <motion.article 
                            ...
                            className="cursor-pointer bg-[#fffbf3]">
                                ...
                                />
                                <div className='p-5 pb-8 flex flex-col justify-center items-center text-center relative'>
                                    <div className="absolute w-full h-[50px] top-[-50px] left-0 bg-gradient-to-b from-transparent to-[#fffbf3]"></div>
